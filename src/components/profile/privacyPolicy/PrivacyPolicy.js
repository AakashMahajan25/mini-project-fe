...
function PrivacyPolicy() {
    return (
        <div className='privacypolicy-css'>
            ...
            <h2 className='text-heading'>1. CHANGES TO THIS PRIVACY NOTICE</h2>
            ...
            <h2 className='text-heading'>2. COLLECTION AND USE OF YOUR INFORMATION</h2>
            ...
            <p className='provide-text'>Information You Provide to Us</p>
            <p className='text-subheading3'>
            ...
            <h2 className='text-heading'>3. COOKIES AND OTHER TRACKING TECHNOLOGIES</h2>
            <p className='text-subheading3'>
            ...
            <p className='text-subheading3' style={{ marginTop: 20 }}>To opt out of tracking by Google Analytics,
                <span className='click_text'> click here</span>
            </p>
            <p className='text-subheading3' style={{ marginTop: 20 }}>
            ...
            <h2 className='text-heading'>4. DISCLOSURE OF YOUR INFORMATION</h2>
            <p className='text-subheading3'>
            ...
            <h2 className='text-heading'>5. SOCIAL FEATURES </h2>
            ...
            <h2 className='text-heading'>6. THIRD PARTY WEBSITES AND LINKS </h2>
            <p className='text-subheading4'>
                Certain features of the Services may allow you to initiate interactions between the Services and third-party services or platforms, such as social networks (“Social Features”). Social Features include features that allow you to access our pages on third-party platforms, and from there “like” or “share” our content. Use of Social Features may allow a third party to collect and/or use your information. If you use Social Features, information you post or make accessible may be publicly displayed by the third-party service. Both we and the third party may have access to information about you and your use of both the Services and the third-party service. For more information, see the section below, Third Party Websites and Links.
            </p>
            <h2 className='text-heading'>7. CHILDREN’S PRIVACY </h2>
            <p className='text-subheading4'>
            ...
            <h2 className='text-heading'>8. DATA SECURITY AND RETENTION</h2>
            <p className='text-subheading4'>
            ...
            <h2 className='text-heading'>9. HOW TO CONTACT US </h2>
            <p className='text-subheading4'>
