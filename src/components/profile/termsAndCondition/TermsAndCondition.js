            ...
            <div className=''>
                ...
                <div className='box1'>
                    ...
                    <p className='text-subheading3'>
                        <span className='headpoint'>i.</span> As a part of the Services, you can input, upload and submit information and other materials (“Input”) into Frruit, and Frruit will use artificial intelligence tools and functionalities to generate responses based on your Input (“Output”). Your use of Frruit, including any Outputs, may also be subject to license and use restrictions set forth in a third-party LLM license, if applicable. Any Input will be deemed “Your Content” under these Terms.
                    </p>
                    <p className='text-subheading3'>
